            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ isset($getCategoryData) ? route('updateCategories', ['id' => $getCategoryData->id]) : route('addCategories') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="category_description" class="form-control" placeholder="Category Description" id="category_description" rows="3">{{ old('category_description', $getCategoryData->category_description ?? '') }}</textarea>
                    </div>
