    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ isset($getSubCategoryData) ? route('updateSubCategories', ['id' => $getSubCategoryData->id]) : route('addSubCategories') }}" 
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="sub_category_description" class="form-control" placeholder="Sub Category Description" 
                            id="sub_category_description" rows="3">{{ old('sub_category_description', $getSubCategoryData->sub_category_description ?? '') }}</textarea>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="mt-2">
                            <img src="{{ asset('storage/sub_categories/' . $getSubCategoryData->sub_category_images) }}" 
                                alt="{{ $getSubCategoryData->sub_category_name }}" width="100">
                        </div>
                        @endif
                        @error('sub_category_images')
                        <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
